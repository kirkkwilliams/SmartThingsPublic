...
definition(
    ...
    description: "Updates SmartWeather Station Tile devices every 15 minutes.",
...
/*
	...
	def delayTimeSecs = 15 * 60 // reschedule every 15 minutes
	def runAgainWindowMS = 14 * 60 * 1000 // can run at most every 14 minutes
